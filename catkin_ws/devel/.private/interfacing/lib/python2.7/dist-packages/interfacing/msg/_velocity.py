...
class velocity(genpy.Message):
  _md5sum = "050be0bd30e74f253725230b282a1e21"
  _type = "interfacing/velocity"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """int8 leftwheel
int8 rightwheel
"""
  __slots__ = ['leftwheel','rightwheel']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2b().pack(_x.leftwheel, _x.rightwheel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.leftwheel, _x.rightwheel,) = _get_struct_2b().unpack(str[start:end])
      return self
